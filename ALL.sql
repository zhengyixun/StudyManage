...
/****** Object:  Database [MyTest]    Script Date: 2018/12/20 15:52:25 ******/
CREATE DATABASE [MyTest]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MyTest', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\MyTest.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'MyTest_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\MyTest_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [MyTest] SET COMPATIBILITY_LEVEL = 140
GO
...
ALTER DATABASE [MyTest] SET TRUSTWORTHY ON 
GO
...
INSERT INTO 
[dbo].[ManageUser] (uname,pwd,name,mobile,state,loginnum,flag) values ("admin","1","admin","131","1","0","Main,EditPass,welcome,Manage_Users,Manage_Users_Design,Users,User_Design")